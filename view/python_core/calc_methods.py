...
from view.idl_translation_core.ViewCalcData import calc_deltaF


def calc_method_0(
    raw_data: list, background_frames: list, area_mask: np.ndarray
):
    """
    ...
    """
    error = (
        "Calc Method 0 could not handle the raw data provided. It expects a list of "
...
def calc_method_1(
    ...
    """
    error = (
        "Calc Method 1 could not handle the raw data provided. It expects a list of "
...
def calc_method_3(
    ...
    """
    error = (
        "Calc Method 3 could not handle the raw data provided. It expects a list of "
        "at least one numpy ndarray, the first of which will be used"
    )
...
def calc_method_4(
    ...
    """
    error = (
        "Calc Method 4 could not handle the raw data provided. It expects a list of "
    ...
    # convert back to XYT
    relative_ratio_xyt = np.moveaxis(
        relative_ratio_txy, source=0, destination=-1
    )
